...
def testar_cache_cartao():
    ...
    try:
        ...
        usuarios_disponiveis = db.executar_query("SELECT id, username FROM usuarios LIMIT 10", [])
        ...
        usuario_test = usuarios_disponiveis[0]['username']
        ...
        if not user_id:
            print("❌ Erro ao obter ID do usuário")
            return False
